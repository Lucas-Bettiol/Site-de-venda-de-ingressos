...
-- Schema DB_Ingressos
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `DB_Ingressos` DEFAULT CHARACTER SET utf8mb3 ;
USE `DB_Ingressos` ;
...
CREATE TABLE IF NOT EXISTS `DB_Ingressos`.`Ingressos` (
  ...
  `Ingresso_Valor` FLOAT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `DB_Ingressos`.`Usuarios` (
  ...
  `Usuario_Admin` TINYINT(1) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `DB_Ingressos`.`Pedidos` (
  ...
  `Pedido_Valor` FLOAT NULL DEFAULT NULL,
